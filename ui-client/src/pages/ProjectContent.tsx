	...
	useEffect(() => {
		const fetchProject = async () => {
			try {
				...
				const contract = new ethers.Contract("0x72d62F5849B6F22Fe4000478355270b8e776D6Db", ABI, signer);
		...
		<div className="max-w-4xl mx-auto p-4 space-y-6">
			...
			<div className="space-y-4">
				...
				<div>
					...
					<p>{project.file}</p>
					<a href={documentLink!} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
						View on IPFS
					</a>
				</div>
